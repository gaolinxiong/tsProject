...
var matrix_util_2 = require("@antv/matrix-util");
exports.transform = matrix_util_2.transform;
/**
 * 对元素进行平移操作。
...
function translate(element, x, y) {
    var matrix = matrix_util_1.transform(element.getMatrix(), [['t', x, y]]);
...
function rotate(element, rotateRadian) {
    ...
    var matrix = matrix_util_1.transform(element.getMatrix(), [
        ['t', -x, -y],
        ['r', rotateRadian],
        ['t', x, y],
    ]);
