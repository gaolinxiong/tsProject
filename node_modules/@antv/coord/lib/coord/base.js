...
var Coordinate = /** @class */ (function () {
    ...
    Coordinate.prototype.invertMatrix = function (x, y, tag) {
        if (tag === void 0) { tag = 0; }
        var matrix = this.matrix;
        var inverted = matrix_util_1.mat3.invert([], matrix);
        var vector = [x, y, tag];
        if (inverted) {
            // 如果为空则不进行矩阵变化，防止报错
    ...
    Coordinate.prototype.rotate = function (radian) {
        ...
        matrix_util_1.mat3.translate(matrix, matrix, [-center.x, -center.y]);
        matrix_util_1.mat3.rotate(matrix, matrix, radian);
        matrix_util_1.mat3.translate(matrix, matrix, [center.x, center.y]);
        return this;
    };
    /**
    ...
    Coordinate.prototype.scale = function (s1, s2) {
        ...
        var center = this.center;
        matrix_util_1.mat3.translate(matrix, matrix, [-center.x, -center.y]);
        matrix_util_1.mat3.scale(matrix, matrix, [s1, s2]);
        matrix_util_1.mat3.translate(matrix, matrix, [center.x, center.y]);
        return this;
    };
    /**
    ...
    Coordinate.prototype.translate = function (x, y) {
        var matrix = this.matrix;
        matrix_util_1.mat3.translate(matrix, matrix, [x, y]);
        return this;
    };
    /**
     * 将坐标系 x y 两个轴进行转置
